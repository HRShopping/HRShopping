...
public class CartAdapterPostData {
    ...
    public static void updateCartData(int number, int id, final updateListener listener) {
        Observable<Response> observable = HttpMethods.getInstance().getCartService().updateCart(number, id);
