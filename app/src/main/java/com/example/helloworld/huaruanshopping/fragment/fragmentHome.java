...
public class fragmentHome extends Fragment implements SwipeRefreshLayout.OnRefreshListener, IFragmentBaseView {
    ...
    private FragmentHomePresenter mFragmentHomePresenter = new FragmentHomePresenter(this);
...
//                    pageNum++;
    ...
    public void addMoreData() {
        loading = false;
        mFragmentHomePresenter.getHomePrudoct(pageNum, 2);
        pageNum = pageNum + 1;
    }
...
//            mHandler.sendEmptyMessageDelayed(0x111, 2000);
        ...
        mProductList.clear();
        mFragmentHomePresenter.getHomePrudoct(1, 2);
        pageNum = 2;
    }
