...
public class FragmentSortPresenter implements IFragmentSortBiz {
    ...
    public void getCategory() {
        Observable<categoryList> observable = HttpMethods.getInstance().getCategoryService().getCategory();
...
//                        Log.d("11", "onNext: " + categoryList.getCategoryList().get(0).getType());
                        iFragmentSort.setCategoryText(setCategoryText(categoryList.getCategoryList()));
                    }
    ...
    private List<String> setCategoryText(List<Category> categories) {
